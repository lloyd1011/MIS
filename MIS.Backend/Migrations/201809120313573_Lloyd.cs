namespace MIS.Backend.Migrations
{
    ...
    public partial class Lloyd : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        College_Id = c.String(maxLength: 128),
                        OrganizationType_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                ...
                c => new
                    {
                        ...
                        AdviserOrganization_Id = c.String(maxLength: 128),
                        Liability_Id = c.String(maxLength: 128),
                ...
                c => new
                    {
                        ...
                        Adviser_Id = c.String(maxLength: 128),
                        College_Id = c.String(maxLength: 128),
                        Organization_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                ...
                c => new
                    {
                        ...
                        Adviser_Id = c.String(maxLength: 128),
                        Organization_Id = c.String(maxLength: 128),
                        SchoolYear_Id = c.String(maxLength: 128),
                ...
                c => new
                    {
                        ...
                        Activity_Id = c.String(maxLength: 128),
                        Organization_Id = c.String(maxLength: 128),
                        Student_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Students", "College_Id", "dbo.Colleges");
            ...
            DropIndex("dbo.StudentPositions", new[] { "CreatedAt" });
            ...
            DropIndex("dbo.NotificationReadAdvisers", new[] { "CreatedAt" });
            ...
            DropIndex("dbo.Attendances", new[] { "CreatedAt" });
            DropIndex("dbo.Years", new[] { "CreatedAt" });
            DropIndex("dbo.Students", new[] { "Year_Id" });
            DropIndex("dbo.Students", new[] { "College_Id" });
            DropIndex("dbo.Students", new[] { "CreatedAt" });
            DropIndex("dbo.Semesters", new[] { "CreatedAt" });
            DropIndex("dbo.SchoolYears", new[] { "CreatedAt" });
            ...
            DropIndex("dbo.Liabilities", new[] { "CreatedAt" });
            DropIndex("dbo.Advisers", new[] { "CreatedAt" });
            ...
            DropIndex("dbo.AdviserOrganizations", new[] { "CreatedAt" });
            ...
            DropIndex("dbo.AdviserNotifications", new[] { "CreatedAt" });
            DropIndex("dbo.Admins", new[] { "CreatedAt" });
            DropIndex("dbo.OrganizationTypes", new[] { "CreatedAt" });
            DropIndex("dbo.Colleges", new[] { "CreatedAt" });
            ...
            DropIndex("dbo.Activities", new[] { "CreatedAt" });
