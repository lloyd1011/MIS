namespace MIS.Backend.Migrations
{
    ...
    public partial class Management : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        UserCredential_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Officers", "UserCredential_Id", "dbo.UserCredentials");
            ...
            DropForeignKey("dbo.Deans", "UserCredential_Id", "dbo.UserCredentials");
            DropForeignKey("dbo.Deans", "College_Id", "dbo.Colleges");
            DropForeignKey("dbo.CollegeCoordinators", "UserCredential_Id", "dbo.UserCredentials");
            ...
            DropForeignKey("dbo.Students", "UserCredential_Id", "dbo.UserCredentials");
            ...
            DropForeignKey("dbo.Advisers", "UserCredential_Id", "dbo.UserCredentials");
            DropForeignKey("dbo.Admins", "UserCredential_Id", "dbo.UserCredentials");
            ...
            DropIndex("dbo.Officers", new[] { "UserCredential_Id" });
            ...
            DropIndex("dbo.Students", new[] { "UserCredential_Id" });
            ...
            DropIndex("dbo.Advisers", new[] { "UserCredential_Id" });
            ...
            DropIndex("dbo.UserCredentials", new[] { "CreatedAt" });
            DropIndex("dbo.Admins", new[] { "UserCredential_Id" });
